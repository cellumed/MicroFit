...
import com.cellumed.healthcare.microfit.DAO.DAORegUser;
...
public class BudUtil {
    private final static String PREF_NAME = "com.ikoob.ems_ui";


    private static volatile BudUtil INSTANCE;

    public static DAORegUser regUser = new DAORegUser();
    public static ArrayList<Activity> actList = new ArrayList<>();
    public static String USER_ID = "";
    public static String FWVersion = "1.0";
    public static String HWVersion = "1.0";
