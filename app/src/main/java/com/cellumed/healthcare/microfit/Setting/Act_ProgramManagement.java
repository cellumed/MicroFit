...
import com.cellumed.healthcare.microfit.DataBase.DBOpenHelper;
import com.cellumed.healthcare.microfit.R;

public class Act_ProgramManagement extends BTConnectActivity {
    ListView listView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.act_program_management);
        mContext = this;

        Fragment mFragment = Frag_SettingProgram.newInstance();
